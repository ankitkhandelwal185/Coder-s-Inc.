...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            this.f=(FrameLayout)itemView.findViewById(R.id.frame_color);
            this.f1=(FrameLayout)itemView.findViewById(R.id.upcomming);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.current_card_layout, parent, false);


        //view.setOnClickListener(MainActivity.myOnClickListener);

        MyViewHolder myViewHolder = new MyViewHolder(view);
        myViewHolder.itemView.setOnClickListener(DataAdapter.this);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        FrameLayout frameLayout1 = holder.f1;
        // cardview.setBackgroundColor(Color.rgb(236,239,241));
        ...
        if (dataSet.get(listPosition).getSitename().equals("Codeforces")) {
            //Log.e("adapter","hackerearth");
            frameLayout.setBackgroundColor(Color.rgb(222, 185, 135));
        }
        ...
        textsync.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dataSet.get(listPosition).getType().equals("upcoming")) {
                    ...
                    long epoch = (dateup.getTime() - 19800000);
                    abc=epoch;
                    //System.out.println(epoch);
                    // calintent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, epoch);
                    calintent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, epoch);
            ...
            public void onClick(View v) {
                ...
                if (type.equals("present")) {
                    ...
                    if (PendingIntent.getBroadcast(context, 0,
                        ...
                        alarmManager.setRepeating(AlarmManager.RTC_WAKEUP,abc, AlarmManager.INTERVAL_DAY, pendingIntent);
                    }
                }*/
            }
        });
