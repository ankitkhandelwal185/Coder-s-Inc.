package app.the.iway.codersinc.LoginSignup;
    ...
    private void registerUser() {
        ...
        if (name != null && username != null && password != null && email != null) {
            if (isValidEmail(email) && isValidPassword(password)) {
                register(name, username, password, email);
                //Log.e("signup", " " + username + " " + password);
                ...
                if (isValidEmail(email)) {
                    ...
                    Toast.makeText(SignupActivity.this, "password is too short And email id is wrong", Toast.LENGTH_SHORT).show();
                }
            }
        }
        else{
